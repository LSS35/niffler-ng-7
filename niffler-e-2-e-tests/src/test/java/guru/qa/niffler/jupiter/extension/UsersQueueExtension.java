...
public class UsersQueueExtension implements
    ...
    public static final Queue<StaticUser> NOT_EMPTY_USERS = new ConcurrentLinkedQueue<>();

    static {
        EMPTY_USERS.add(new StaticUser("user1", "user1", true));
        NOT_EMPTY_USERS.add(new StaticUser("user2", "user2", false));
        NOT_EMPTY_USERS.add(new StaticUser("user3", "user3", false));
    }
